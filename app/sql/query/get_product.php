 ...
 * @return string[]|string|null|false
 */
function getRandomProductByCategory($n = 3, $category = "", $gender = "")
{
  global $conn;
...
function getProductsBySearch($searchQuery)
{
  ...
  if ($searchQuery != '' || $searchQuery != null) {
    ...
    $sql .= " WHERE product.name LIKE '%" . mysqli_real_escape_string($conn, $searchQuery) . "%' OR brand LIKE '%" . mysqli_real_escape_string($conn, $searchQuery) . "%';";
