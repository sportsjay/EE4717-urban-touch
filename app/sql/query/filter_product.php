 ...
 * Filter based on price range (minimum and maximum),
 * product gender type
 ...
 */
function getFilteredProduct($brand = "")
{
  global $conn;
  ...
  $filterQuery = 'JOIN category ON category.id = product.category_id WHERE price>=' . $lowPrice . ' and price<=' . $highPrice . $brandFilter;
